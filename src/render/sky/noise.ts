...
export const WEATHER_CELL_SPACING_M = 1200
...
/** Two RGBA8 planes: each texel's winning cloud, then its runner-up. */
export const weatherByteLength = (): number => WEATHER_SIZE ** 2 * 8
