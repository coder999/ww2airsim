...
/**
 * Where the aeroplane starts: over open water, comfortably above the clean,
 ...
 *
 * **Why this exists, since a URL that moves the aeroplane is otherwise a
 * cheat.** Tier 2 has to fly over Leyte, and Leyte is not where the aeroplane
 ...
 * path: `initialFrameState` already takes the aeroplane it is handed, and
 ...
 * silent fallback would put the aeroplane back over open water and a terrain
