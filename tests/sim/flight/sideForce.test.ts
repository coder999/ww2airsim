...
describe('sustained rudder turns the airplane, not just its nose', () => {
  ...
  it('keeps turning the flight path for as long as the rudder is held', () => {
    ...
    // 122.0 deg, slip settled at -8.1 deg -- and, once rate authority became
    // proportional to speed the same day (the rudder rate at 50 m/s roughly
    // doubled): heading 163.1, track 153.2, slip -9.8. Before the term existed the track did not
