...
describe('the audio cue reducer (design §6.2)', () => {
  ...
  it('does not squeak when the flight RESTARTS onto the ground', () => {
    ...
    // The wreck must be AIRBORNE for this to discriminate: `advance` freezes
    // the airplane where it hit, and flying into a hillside leaves it off the
    // ground. An earlier version of this test settled the wreck onto the
