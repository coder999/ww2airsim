...
| 6 | 13 — in progress | Combat and damage | §6 | Playable gunnery slice landed 2026-09-19 (guns, ballistics, aircraft damage, `gunnery-range`); [design](2026-09-19-combat-design.md), [handoff](../../handoff/2026-09-19-plan6-gunnery.md). Plan 6b's strike slice (bombs, rockets, stores, ship and structure damage, `strike-range`, a title-screen loadout picker) landed 2026-09-22, Tier 1-verified; Tier 2 GPU acceptance has not been run yet ([design](2026-09-20-strike-design.md), [handoff](../../handoff/2026-09-22-plan6b-strike.md)). Torpedoes (a second airframe) and structural-overload damage remain |
