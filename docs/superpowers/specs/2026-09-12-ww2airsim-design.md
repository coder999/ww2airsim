...
*Amended 2026-09-26 (Plan 7c): `aiHint` is not authored. It is derived from `geometry`, `mass`, `engine`, `limits` and `reference` by `relativeEnvelope` (`src/sim/ai/envelope.ts`), so a new airframe needs no AI content.*

*Amended 2026-09-26 (Plan 7c Task 14): `content/aircraft/*.json` may carry an optional `ai: { excludedManeuvers: [...] }` block, which takes named AI maneuvers out of whichever pilot flies that airframe, whatever its skill (`src/sim/ai/maneuvers.ts`, `airframeRepertoire`). Absent, the airframe behaves as before, so a new airframe still needs no AI content. Names are validated against a literal list in `src/sim/flight/schema.ts` (`EXCLUDABLE_MANEUVERS`: every `ManeuverName` except the three intent defaults, which are always flown), pinned to `ManeuverName` by `tests/sim/ai/maneuvers.test.ts`. The A6M2 excludes `immelmann`, on Mark's decision of 2026-09-26 ("suppress the immelman for the zero specifically but leave it available to other enemy plane AIs"). Measured by the 7c final review, 2026-09-26, zero-merge flown as a veteran, clean loadout: with the Immelmann, 0 of 4 runs fired again within 150 s; without it, 4 of 4 fired again at 102.9-113.7 s (re-measured the same by Task 14; asserted in `tests/render/aiReengage.test.ts`).*
...
| 6 | 13 — complete for the current airframe | Combat and damage | §6 | Playable gunnery landed 2026-09-19 ([design](2026-09-19-combat-design.md), [handoff](../../handoff/2026-09-19-plan6-gunnery.md)); bombs, rockets, stores, ship and structure damage landed 2026-09-22 ([design](2026-09-20-strike-design.md), [handoff](../../handoff/2026-09-22-plan6b-strike.md)); deterministic G/overspeed structural damage landed 2026-09-23 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-23-structural-overload-design.md), [handoff](../../handoff/2026-09-23-plan6c-structural-overload.md)). Torpedoes remain explicitly deferred until a second, historically appropriate airframe exists and do not block Plan 7 |
| 7 | 14 — 7a/7b/7c/7d complete (7c merged to main 2026-09-26) | AI | §7 | 7a (flight controller, pursuit pilot, gun gate) landed 2026-09-23 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-23-ai-pursuit-design.md), [handoff](../../handoff/2026-09-23-plan7a-ai-pursuit.md)). 7b (pilot skill, energy-state Pursue/Extend/Break decision layer, minimum-engagement-range override) landed 2026-09-23 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-23-combat-depth-design.md), [plan](../plans/2026-09-23-plan7b-combat-depth.md), [handoff](../../handoff/2026-09-23-plan7b-combat-depth.md)). 7d (perception staleness and skill-scaled control noise, closing "I can't ever get behind that pilot" at `green` skill) landed 2026-09-24 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-24-ai-pursuit-difficulty-design.md), [plan](../plans/2026-09-24-ai-pursuit-difficulty.md), [handoff](../../handoff/2026-09-24-plan7d-ai-pursuit-difficulty.md)); the final review's broad Tier 2 re-run also found `ai-maneuver.spec.ts`'s point-blank break-off gate newly red (veteran pursuer now kills a passive player before reaching it — a real balance side effect, open for Mark's ruling, see handoff). 7c (veteran retune, AI safety envelope, re-engagement after a missed merge, lift-vector controller, named maneuver library) is complete and merged to `main` (2026-09-26). Its two merge blockers and the final review's low-target finding were resolved by Mark's decisions of 2026-09-26: green lost lag pursuit (the 7d bar now holds at all 4 noise cursors, behind at 18-20 s), the A6M2's content excludes the Immelmann (a veteran AI Zero fires again after the merge at every cursor), and a pursuing AI follows a low target down to 50 ft above the ground (0 crashes in 104 low-chase runs); reference-GPU Tier 2 ran ([design](2026-09-25-ai-7c-design.md), [plan](../plans/2026-09-25-ai-7c-safety-and-maneuvers.md), [handoff](../../handoff/2026-09-26-ai-7c.md)); the AI still passes the player at 22 m head-on by design (ruling R4), pending Mark's ruling on dodging it; ai-maneuver.spec.ts passed on the reference GPU only because its closest-range check reads the first sample under 120 m, not the minimum (see handoff). 7e (sides), 7f (formation), 7g (landing AI) not started |
| 9 | 15 | Meta-game | §8 | Title screen landed 2026-09-19 ([design](2026-09-19-title-screen-design.md), [handoff](../../handoff/2026-09-19-title-screen.md)). Roster, live scoring and dynamic scenario switching (return-to-title, no reload) landed 2026-09-23/24 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-23-meta-game-design.md), [plan](../plans/2026-09-23-plan9-meta-game.md), [handoff](../../handoff/2026-09-23-plan9-meta-game.md)). Missions: M1, the sim-side engine (objectives, triggers, held groups, outcome and badge rule), complete 2026-09-25, Tier 1 only ([design](2026-09-25-missions-design.md), [plan](../plans/2026-09-25-m1-mission-engine.md), [handoff](../../handoff/2026-09-25-m1-mission-engine.md)); M2 (UI), M3 (Deck Quals, Airfield Strike, Convoy Strike) and M4 (Combat Air Patrol, after 7e) not started, so no shipped scenario declares an objective yet. Loading strip and boot-freeze fix, pilot Dossier (career record, mission log) landed 2026-09-26 ([design](2026-09-25-loading-and-dossier-design.md), [plan](../plans/2026-09-25-loading-and-dossier.md), [handoff](../../handoff/2026-09-26-loading-and-dossier.md)); the Dossier's badge section stays empty until M2 writes `badges[]`. Open: roster export/import has no UI caller yet (a replace-vs-merge design decision is needed first) |
| UI realism | any | Quality settings, terrain asset quality, arcade damage and Naval Communications UI | §4, §8 | Complete 2026-09-24 with Tier 1 and reference-GPU Tier 2 acceptance ([render-quality design](2026-09-24-render-quality-selector-design.md), [Naval Communications design](2026-09-24-naval-comms-ui-design.md), [plan](../plans/2026-09-24-plan-ui-realism.md), [handoff](../../handoff/2026-09-24-plan-ui-realism.md)). Open: the first-visit Asset Quality default remains `low` until terrain mesh textures are allocated on demand; `high`/`ultra` reserve download headroom for later texture work and currently select the same L0 terrain as `medium`; the underlying vsynced quality-probe calibration remains the open 2026-09-20 incident, now visible and overridable rather than silent. |
| Visual realism §2.1 | any | Terrain surface textures | §4 | Landed 2026-09-26: five CC0 Poly Haven materials as KTX2 arrays (2.77 MB), texel/mean modulation under unchanged blend weights, off at scenery low ([spec](2026-09-24-visual-realism-pass-design.md), [plan](../plans/2026-09-26-terrain-surface-textures.md), [handoff](../../handoff/2026-09-26-terrain-textures.md)). Open: hue modulate-vs-replace is Mark's eye call; §2.2/§2.3/§3 not started. |
| F4F Wildcat | any | Real rigged Wildcat glTF as the default rendered/animated aircraft, replacing the Hellcat's procedural mesh for every entity in the world | §4, §9, §10 | Complete 2026-09-24 with Tier 1 and reference-GPU Tier 2 acceptance ([plan](../plans/2026-09-24-f4f-wildcat-default-aircraft.md), [handoff](../../handoff/2026-09-24-f4f-wildcat-default-aircraft.md)). Flight-model physics are unchanged: every scenario still flies `f6f-hellcat.json`'s numbers; `f4f-wildcat.json` exists as schema-validated but explicitly placeholder content (borrowed Hellcat figures), unreferenced by any scenario. No flap geometry on this model. Every aircraft in the world, including AI, now renders as a Wildcat. Per-spec model selection (`view.model`) arrived with Z1; see the A6M Zero row. |
| Hangar (H1-H3) | any | Object library and articulation test bench: `hangar.html` | §8, §9 | H1 complete 2026-09-25 with Tier 1 and reference-GPU Tier 2 ([design](2026-09-25-hangar-library-design.md), [plan](../plans/2026-09-25-h1-hangar-library.md), [handoff](../../handoff/2026-09-25-h1-hangar-library.md)): 32-entry library checked against GAMEPLAY.md's rosters, live figures, turntable, gear/prop bench behind `?bench`. H2 complete 2026-09-26 with Tier 1 and reference-GPU Tier 2 (checks 1-3, 5-10: 11/11) ([plan](../plans/2026-09-26-h2-hangar-bench.md), [handoff](../../handoff/2026-09-26-h2-hangar-bench.md)): stores toggles, Cycle through the sim's own gear/flap transit, pivot gizmos, wireframe, turntable, counts against the manifest budget; `docs/models.md` runbook. H3 (turrets) open. Found: the Wildcat's stores offsets do not fit its model |
...
| 16 | any | Clouds | §4 | 16a volumetric layers + whiteout landed 2026-09-19 ([design](2026-09-19-clouds-design.md), [handoff](../../handoff/2026-09-19-plan16a-clouds.md)); 16b cloud shadows landed 2026-09-19 ([design](2026-09-19-cloud-shadows-design.md), [handoff](../../handoff/2026-09-19-plan16b-cloud-shadows.md)); 16c movable sun landed 2026-09-19 ([design](2026-09-19-sun-design.md), [handoff](../../handoff/2026-09-19-plan16c-sun.md)); cloud fidelity II (depth-reconstructed motion, amortized High march, weather-map cells, packed multiscale noise) landed 2026-09-25 ([design](2026-09-25-cloud-fidelity-ii-design.md), [handoff](../../handoff/2026-09-25-cloud-fidelity-ii.md)); cloud VDB fidelity (procedural cumulus archetype, coverage as sky fraction, in-cloud budget) merged 2026-09-26 ([plan](../plans/2026-09-26-cloud-vdb-coverage.md), [handoff](../../handoff/2026-09-26-cloud-vdb-fidelity.md)); slice banding and the horizon-band flicker fixed 2026-09-26 (full march jitter, far edges keep history; Mark flew it: usable, High clean); open: Low still shimmers at cloud edges |
| 17 | any | Radar | — | Complete 2026-09-23; [design](2026-09-23-radar-design.md), [handoff](../../handoff/2026-09-23-plan17-radar.md) |
| A6M Zero (Z1-Z3) | any | Second airframe: model pipeline and runtime (Z1), graded A6M2 flight model and mixed armament (Z2), the Zero on screen (Z3) | §4, §5, §7, §10 | Z1 complete 2026-09-25 with Tier 1 and reference-GPU Tier 2 (`wildcat.spec.ts`, `entities.spec.ts`, `hangar.spec.ts`: 10/10, gpu p95 5.41 ms) ([design](2026-09-25-a6m-zero-design.md), [plan](../plans/2026-09-25-z1-model-pipeline.md), [handoff](../../handoff/2026-09-25-z1-model-pipeline.md)): manifest-driven `models:build`, shared model cache, per-spec `view.model`; no new asset. Z2 complete 2026-09-25, headless, Tier 1 only ([plan](../plans/2026-09-25-z2-zero-flight-model.md), [handoff](../../handoff/2026-09-25-z2-zero-flight-model.md)); the Zero is in no shipped scenario until Z3's zero-range. It is drawn with the Wildcat stand-in (`view.model: wildcat`) and is in service in the Hangar. Z3 not started |
| Effects realism | any | Photoreal explosions and water splashes: bomb, rocket, shell and crash detonations over land and water (fireball, smoke column, debris; splash plume, spray and foam ring) | §4 | Not started; requested by Mark 2026-09-26; [design](2026-09-26-ordnance-and-effects-design.md) for Mark's review 2026-09-26 proposes E1 (effects engine), E2 (baked flipbooks), E3 (water). Today every detonation and crash is one camera-facing quad that grows and fades (`src/render/scene/impactEffect.ts`; ordnance impacts reuse its curve in `src/render/ordnance.ts`), verified 2026-09-26 by reading both. Needs its own design |
| Ordnance models | any | Source real 3D models for bombs, rockets and other stores (drop tanks, HVAR rails, torpedoes later) to replace the primitive meshes | §4, §9, §10 | Not started; requested by Mark 2026-09-26; plan O1 of the [ordnance and effects design](2026-09-26-ordnance-and-effects-design.md), models generated by script (Mark's choice). Bombs and rockets are box and cylinder `InstancedMesh` pools in `src/render/ordnance.ts` today. `ASSETS.md`'s candidate table lists one bomb (`bomb-m64-500lb.glb`, CC-BY 4.0, not shipped) and no rocket; its only torpedo is a 1904 ship torpedo, not the aerial Mk 13. Ships through Z1's `models:build` pipeline and the Hangar |
| Ship models (S1-S2) | any | Licensed ship models fitted to the sim's ShipSpecs: the three shipped ships (S1), the rest of the roster (S2) | §4, §10 | S1 complete, merged 2026-09-26 with Tier 1 and reference-GPU Tier 2 (deck probe within 0.2 m after a floating-origin fix, deck/runway luminance 0.617, 4K deckquals 13.41 / 7.79 ms) ([design](2026-09-25-ship-models-design.md), [plan](../plans/2026-09-25-s1-ship-models.md), [handoff](../../handoff/2026-09-25-s1-ship-models.md)): the CV-6 as the Essex, the Fletcher, the Liberty as the Type B maru; box fallback kept. S2 open |
