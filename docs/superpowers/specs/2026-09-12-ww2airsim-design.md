...
| 9 | 15 | Meta-game | §8 | Title screen landed 2026-09-19 ([design](2026-09-19-title-screen-design.md), [handoff](../../handoff/2026-09-19-title-screen.md)). Roster, live scoring and dynamic scenario switching (return-to-title, no reload) landed 2026-09-23/24 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-23-meta-game-design.md), [plan](../plans/2026-09-23-plan9-meta-game.md), [handoff](../../handoff/2026-09-23-plan9-meta-game.md)). Open: roster export/import has no UI caller yet (a replace-vs-merge design decision is needed first); badge content (no scenario declares an objective yet) |
