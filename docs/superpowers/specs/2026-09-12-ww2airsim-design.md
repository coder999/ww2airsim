...
| 7 | 14 — 7a complete | AI | §7 | 7a (flight controller, pursuit pilot, gun gate) landed 2026-09-23 with Tier 1 and reference-GPU Tier 2 acceptance ([design](2026-09-23-ai-pursuit-design.md), [handoff](../../handoff/2026-09-23-plan7a-ai-pursuit.md)). 7b/7c (pilot skill, energy-state decisions, defensive maneuvers, formation, landing AI, teams) not started |
