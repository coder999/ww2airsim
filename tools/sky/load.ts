...
import { cumulusByteLength, curlByteLength, weatherByteLength, detailByteLength, shapeByteLength } from '../../src/render/sky/noise.js'
...
export const cumulusPath = (): string => join(SKY_DIR, 'cumulus.bin.gz')
...
export const loadCumulus = (): Uint8Array => inflate(cumulusPath(), cumulusByteLength())
